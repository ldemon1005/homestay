            ...
            <div class="slide-container">
                <div class="owl-carousel owl-carousel-1 owl-theme">
                    ...
                    @foreach($homestay->homestayimage as $homestayimage)
                        <div class="slide-item-1"><img onclick="lightbox({{$i}})"
                                                       src="{{env('HOST_URL')}}/local/storage/app/image/resized-{{$homestayimage->homestay_image_img}}">
                        </div>
                        @php $i++; @endphp
                    @endforeach
                </div>
                    ...
                    @foreach($nearby_homestay as $homestay)
                        <div class="slide-item">
                            <a href="{{ asset('detail/'.$homestay->homestay_id) }}" class="slide-image"
                               style="display:block; background-image: url(http://localhost/host-homestay/local/storage/app/image/resized-{{$homestay->homestay_image}})">
